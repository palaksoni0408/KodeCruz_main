...
declare const emailTemplateTypes: readonly ["email_verification", "password_reset", "magic_link", "team_invitation", "sign_in_invitation"];
declare const emailTemplateAdminReadSchema: yup.ObjectSchema<{
    type: "email_verification" | "password_reset" | "magic_link" | "team_invitation" | "sign_in_invitation";
    subject: string;
    content: {} | null;
    is_default: boolean;
}, yup.AnyObject, {
