...
var oauthProviderReadSchema = (0, import_schema_fields.yupObject)({
...
var oauthProviderWriteSchema = oauthProviderReadSchema.omit(["provider_config_id"]);
...
var projectsCrudAdminReadSchema = (0, import_schema_fields.yupObject)({
  ...
  config: (0, import_schema_fields.yupObject)({
    ...
    oauth_providers: (0, import_schema_fields.yupArray)(oauthProviderReadSchema.defined()).defined(),
...
var projectsCrudAdminUpdateSchema = (0, import_schema_fields.yupObject)({
  ...
  config: (0, import_schema_fields.yupObject)({
    ...
    oauth_providers: (0, import_schema_fields.yupArray)(oauthProviderWriteSchema.defined()).optional().default(void 0),
